  ...
  return (
    <div className="auth-container">
      <div className="auth-toggle">
        <button onClick={() => setShowSignIn(true)} className={showSignIn ? 'active' : ''}>Sign In</button>
        <button onClick={() => setShowSignIn(false)} className={!showSignIn ? 'active' : ''}>Sign Up</button>
      </div>
